...
const ContactUs = () => {
  ...
  return (
    <div className=' space-y-4'>
        ...
        <div>
            <h1 className='text-[#292F36] font-DMSerif text-[40px] lg:text-[35px] md:text-[25px] my-3 sm:text-[15px] text-center px-[25%] md:px-[15%]'>We love meeting new people and helping them.
</h1>
...
<div className='flex justify-center sm:flex-col space-x-[50px] sm:space-x-[0px] px-[10%] sm:px-[5%]'>
    ...
    <div className='font-Jost py-6'>
        <form action="" className='space-y-[30px] md:space-y-[10px] text-[14px] sm:text-[11px]'> 
            <div className='flex  gap-6 md:gap-3'>
            <input type="text" name="" id="" className='border-b-[1px] border-[black] py-2 outline-none placeholder:text-[black] w-[300px] lg:w-[200px] md:w-[150px] sm:w-[50%]' placeholder='Name'/>
            <input type="email" name="" id="" className='border-b-[1px] border-[black] py-2 outline-none placeholder:text-[black] w-[300px] lg:w-[200px] md:w-[150px] sm:w-[50%]' placeholder='Email'/>
            </div>
            <div className='flex  gap-6 md:gap-3'>
                <input type="text" name="" id="" placeholder='Subject' className='border-b-[1px] border-[black] py-2 outline-none placeholder:text-[black] w-[300px] lg:w-[200px] md:w-[150px] sm:w-[50%]'/>
                <input type="tel" name="" id="" placeholder='Phone'  className='border-b-[1px] border-[black] py-2 outline-none placeholder:text-[black] w-[300px] lg:w-[200px] md:w-[150px] sm:w-[50%]'/>
                </div>
                <textarea name="" id="" placeholder='Hello Iam Intrested in..'  className='border-b-[1px] border-[black] py-2 outline-none placeholder:text-[black] w-[100%] h-[130px] md:h-[100px]'></textarea>
                <div className='flex justify-end'>
                <button className='bg-[#292F36] rounded-[18px] p-[20px_30px] md:p-[10px_20px] text-[white] text-[18px] md:text-[13px] sm:text-[11px]'>Send Now <span className='text-[#CDA274]'>🡪</span></button>
                </div>
        </form>
    </div>
</div>
