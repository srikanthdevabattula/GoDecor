...
<div className='px-[8%] lg:px-[5%] md:px-[10%] flex md:flex-col gap-3'>
    ...
    <div className='billing'>
        ...
        <form action="" className='font-Jost  text-[#191C1F] text-[14px] space-y-[20px]'>
          <div className='space-y-[20px]'>  <div className='flex space-x-2 items-center '>
       ...
       <div className='flex w-[100%] space-x-3 pt-[20px] sm:pt-[50px] text-[12px] sm:text-[10px]'>
            ...
            <div className='paymentOptions text-[#191C1F] border-[1px] rounded-[4px]'>
                ...
                <div className='border-t-[1px] border-b-[1px] text-[14px] lg:text-[13px] md:text-[12px] flex flex-wrap items-center gap-2 justify-center py-[30px]'>
                    ...
                    <div className='flex flex-col items-center  space-y-2 px-[40px] lg:px-[30px]  md:px-[20px] border-r-[1px] '>
                        <img src={v} alt="v"  className='lg:w-[25px] md:w-[20px]'/>
                        <p>Venmo</p>
                        <input type="radio" name="" id="" />
                    </div>
                    <div className='flex flex-col items-center space-y-2 px-[40px] lg:px-[30px]  md:px-[20px] border-r-[1px] '>
                        <img src={paypal} alt="pp"  className='lg:w-[25px] md:w-[20px]'/>
                        <p>Paypal</p>
                        <input type="radio" name="" id="" />
                    </div>
                    <div className='flex flex-col items-center space-y-2 px-[40px] lg:px-[30px]  md:px-[20px] border-r-[1px] '>
                        <img src={amazon} alt="ama"  className='lg:w-[25px] md:w-[20px]'/>
                        <p>Amazon Pay</p>
                        <input type="radio" name="" id="" />
                    </div>
                    <div className='flex flex-col items-center space-y-2 px-[40px] lg:px-[30px]  md:px-[20px]'>
                        <img src={creditcard} alt="d/c"  className='lg:w-[25px] md:w-[20px]'/>
                        <p>Debid/Credit Card</p>
                        <input type="radio" name="" id="" />
                    </div>
                    
                </div>

                <div className='p-4 text-[#191C1F] font-Jost space-y-3'>
            ...
            <div className='font-Jost text-[#191C1F] '>
                <h3 className='font-semibold text-[18px]'>Additional Information</h3>

                <h5 className='text-[14px] py-1'>Order Notes <span className='text-[#77878F]'>(Optional)</span></h5>
                <textarea name="" id="" placeholder='Notes about your order, e.g. special notes for delivery' className='h-[100px] w-[100%] border-[1px] rounded-[4px] p-2'></textarea>
            </div>
        </form>
        </div>
         </div>
